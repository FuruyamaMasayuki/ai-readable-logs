// Minimal end-to-end example: write a JSONL log with a redacted secret and a
// grouped error, then read it back through the digest CLI.
//
...
Future<void> main() async {
  ...
  await runWithScope(scope, () async {
    ...
    try {
      ...
      // Already logged by span(); swallow it here for the demo.
    }
  });
